...
class ProfileCompleteEventsAdapter(activityContext: Context) : RecyclerView.Adapter<ProfileCompleteEventsAdapter.MyViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        val view: View = LayoutInflater.from(parent.context)
                .inflate(R.layout.profile_complete_event, parent, false)
